 ...
 * @property {{enabled: boolean, port: number, sslCertPath: string, sslKeyPath: string, mySqlPsw: string, mySqlHost: string, mySqlPort: number}} poolServer
 * @property {{enabled: boolean, mySqlPsw: string, mySqlHost: string, mySqlPort: number}} poolService
 * @property {{enabled: boolean, mySqlPsw: string, mySqlHost: string, mySqlPort: number}} poolPayout
